...
public class add_expense extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton scan = (FloatingActionButton) findViewById(R.id.scan2);
        ...
        Button button = (Button)findViewById(R.id.location2);
        ...
        ini();
        ((TextView)findViewById(R.id.catagory2)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                catagory.add("Clothing");
                catagory.add("Food");
                catagory.add("Education");
                catagory.add("Others");
                ...
                popupWindow2.showAtLocation(findViewById(R.id.add_expense_activity), Gravity.CENTER, 0, -40);
                ...
                list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        ((TextView)findViewById(R.id.catagory2)).setText(cata);
                    }
                });
            }
        });
        ((TextView)findViewById(R.id.data2)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LayoutInflater layoutInflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                ...
                //display the popup window
                popupWindow.showAtLocation(findViewById(R.id.add_expense_activity), Gravity.CENTER, 0, 0);
                    ...
                    public void onSelectedDayChange(@NonNull CalendarView view, final int year, final int month, final int dayOfMonth) {
                        ((Button)customView.findViewById(R.id.yes)).setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                add1.time=add1.time=String.valueOf(year*10000+(month+1)*100+dayOfMonth);
                                ((TextView)findViewById(R.id.data2)).setText(data_r);
                                popupWindow.dismiss();
                            }
                        });
                    }
        ...
        ((Button)findViewById(R.id.save2)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(((EditText)findViewById(R.id.income2)).getText().toString().trim().length()>0
                        &&((EditText)findViewById(R.id.describtion2)).getText().toString().trim().length()>0
                        &&((TextView)findViewById(R.id.data2)).getText().toString()!="Click to choose the date")
                {
                    add1.money=-Double.parseDouble(((EditText)findViewById(R.id.income2)).getText().toString());
                    ...
                    add1.describe=((EditText)findViewById(R.id.describtion2)).getText().toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                if(str != null){
                    add1.money = Double.parseDouble(str);
